...
package Turbomachinery "Compressor, turbine models and the like" 
  ...
  model TurbineStage "Turbine stage according to Stodola's law" 
    ...
    extends FluidInterface.PartialTransportIsentropic(final flowDirection=
  ...
  model TurbineStageAA "Turbine stage according to Stodola's law" 
    
    extends Interfaces.PartialComponent;
    extends FluidInterface.PartialTransportIsentropicAA(final flowDirection=
          Modelica_Fluid.Types.FlowDirection.Unidirectional);
