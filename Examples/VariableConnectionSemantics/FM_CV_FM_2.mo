model FM_CV_FM_2 
  ...
  FluidSandbox.Sources.PrescribedMassFlowRate_TX_A prescribedMassFlowRate_TX_A(
    redeclare package Medium = Medium,
    T=320,
    redeclare package FluidInterface = FluidInterface,
  ...
  Modelica.Blocks.Sources.Sine sine1(
    ...
    freqHz=2,
    amplitude=0.1,
    offset=0) annotation (extent=[-84,70; -64,90], rotation=270);
  annotation (Diagram);
