...
equation 
  ...
  connect(limiter.y, pump.massFlowRate) annotation (points=[-85.7,40; -90,40;
      ...
      rgbcolor={0,0,127},
      smooth=0));
  connect(condenser.port_a, pump.port_a) annotation (points=[141,-80; -90,-80;
        -90,-10; -75,-10], style(
      color=69,
      rgbcolor={0,127,255},
      smooth=0));
  ...
  connect(Pa2bar1.y, p_S) annotation (points=[49.5,65; 34,65; 34,34; 44,34],
      ...
      rgbcolor={0,0,127},
      smooth=0));
  connect(evaporator.port_b, turbine.port_a) annotation (points=[-5,-10; 70,-10;
        70,36; 85,36], style(
      color=69,
      rgbcolor={0,127,255},
      smooth=0));
  ...
  connect(turbine.T_a, partialConversionBlock1.u) annotation (points=[84,41; 80,
      ...
      rgbcolor={0,0,127},
      smooth=0));
  connect(turbine.port_b, condenser.port_b) annotation (points=[105,36; 137,36;
        137,28; 190,28; 190,-80; 161,-80], style(
      color=69,
      rgbcolor={0,127,255},
      smooth=0));
