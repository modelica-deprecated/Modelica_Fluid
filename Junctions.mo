...
package Junctions "Junction and splitter models" 
  ...
  model IdealJunctionAAB 
    "Volume with inlet and outlet ports (flow reversal is allowed, two PortA's, one PortB, not supported for all interfaces)" 
    
    extends Interfaces.PartialComponent;
    
    extends FluidInterface.PartialIdealJunctionAAB;
