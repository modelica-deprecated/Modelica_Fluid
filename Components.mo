...
<p>
This package contains basic components models of the fluid library.
In this first version, all developed components are just
together. In a later version, it might be useful to restructure
with sublibraries.
</p>
</html>"));
...
*/
    ...
    import Modelica.SIunits.Conversions.*;
    import Modelica_Fluid.Types.FrictionTypes;
    import Modelica_Fluid.Types.CrossSectionTypes;
...
email: <A HREF=\"mailto:Martin.Otter@dlr.de\">Martin.Otter@dlr.de</A><br>
  ...
  model LongPipe 
    ...
    parameter Modelica_Fluid.Types.FrictionTypes.Temp frictionType=
        Modelica_Fluid.Types.FrictionTypes.ConstantTurbulent 
      "Type of friction to determine pressure loss";
    parameter Medium.AbsolutePressure dp_nominal(min=1.e-10) = from_bar(1.0) 
      "|frictionType = ConstantLaminar or ConstantTurbulent| Nominal pressure drop";
