...
annotation (
  ...
  Modelica.Blocks.Sources.Ramp N_pump(
    ...
    offset=1500) 
          ...
          rotation=0)));
equation
  connect(Constant1.y, Valve.opening)     annotation (Line(points={{-19,90},{-7,
          90},{-7,45}}, color={0,0,127}));
  ...
  connect(Pump1.inlet, Source.port) annotation (Line(points={{-62.8,32},{-70,32},
          {-70,30},{-80,30}}, color={0,127,255}));
  connect(N_pump.y, Pump1.N_in) annotation (Line(points={{-79,72},{-54.16,72},{
          -54.16,41.6}}, color={0,0,127}));
