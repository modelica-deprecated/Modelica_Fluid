...
model TestMixingVolumes
  ...
  inner Modelica_Fluid.Ambient ambient 
    annotation (Placement(transformation(extent={{-100,-100},{-80,-80}},
          rotation=0)));
equation
  connect(MixingVolume1.port_b, MixingVolume2.port_a) annotation (Line(points={
          {-10,40},{9.8,40}}, color={0,127,255}));
  connect(FlowSource2.port, MixingVolume1.port_a) annotation (Line(points={{-80,
