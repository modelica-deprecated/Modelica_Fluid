...
in file Modelica_Fluid\ModelicaLicense2.html
...
The users guide and reference documentation of the fluid library is under

    Modelica_Fluid \ help \ Documentation \ Modelica_Fluid.pdf
