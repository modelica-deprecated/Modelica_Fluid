package Junctions 
  ...
  model Splitter 
    ...
    extends Modelica_Fluid.Junctions.BaseClasses.PartialSplitter;
  ...
  package BaseClasses 
    model PartialSplitter 
      "Partial bass class for a splitting/joining component with three ports" 
