model TestValveIncompressible "Test case for valves" 
  ...
  Modelica_Fluid.Sources.FixedAmbient_pTX SourceP1(
                                               p=10e5,
...
annotation (
  ...
  Documentation(info=""));
  Modelica_Fluid.Sources.FixedAmbient_pTX SinkP2(
                                             p=1e5,
  redeclare package Medium = Modelica.Media.Water.StandardWater) 
  ...
  Modelica_Fluid.Sources.FixedAmbient_pTX SourceP2(
                                               p=10e5,
  redeclare package Medium = Modelica.Media.Water.StandardWater) 
  ...
  Modelica_Fluid.Sources.FixedAmbient_pTX SourceP3(
                                               p=10e5,
  redeclare package Medium = Modelica.Media.Water.StandardWater) 
