model TestSplitter 
  ...
  Modelica_Fluid.Components.Pipes.LumpedPipe pipe1(
    length=1,
    diameter=1,
    redeclare package Medium = Modelica.Media.Water.StandardWater) 
    annotation (extent=[-10,-30; 10,-10], rotation=0);
  annotation (Diagram);
  Modelica_Fluid.Components.Pipes.LumpedPipe pipe2(
    length=1,
    diameter=1,
    redeclare package Medium = Modelica.Media.Water.StandardWater) 
    annotation (extent=[52,-30; 72,-10], rotation=180);
  Modelica_Fluid.Components.Pipes.LumpedPipe pipe3(
    length=1,
    diameter=1,
    redeclare package Medium = Modelica.Media.Water.StandardWater) 
    annotation (extent=[20,12; 40,32], rotation=270);
  Modelica_Fluid.Components.Sources.FixedAmbient_pTX source2(
    T=278.15,
    p=5e5,
    redeclare package Medium = Modelica.Media.Water.StandardWater) 
    annotation (extent=[80,-30; 100,-10], rotation=180);
  Modelica_Fluid.Components.Sources.FixedAmbient_pTX source3(
    T=283.15,
    p=2e5,
    redeclare package Medium = Modelica.Media.Water.StandardWater) 
  ...
  Modelica_Fluid.Components.Sources.PrescribedAmbient_pTX source1(p=5e5,
      redeclare package Medium = Modelica.Media.Water.StandardWater) 
