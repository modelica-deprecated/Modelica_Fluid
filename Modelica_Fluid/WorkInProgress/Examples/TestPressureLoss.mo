model TestPressureLoss 
  ...
  Modelica_Fluid.PressureLosses.Utilities.QuadraticTurbulent.BaseModel 
    orifice_p1(
    redeclare package Medium = Medium,
    data=lossFactors1) 
...
equation 
  ...
  connect(pump_m1.port, orifice_m1.port_a) annotation (points=[120,70; 140,70],
      style(color=69, rgbcolor={0,127,255}));
  connect(orifice_m1.port_b, ambient_m1.port) annotation (points=[160,70; 180,
        70], style(color=69, rgbcolor={0,127,255}));
  connect(ambient.port, orifice_p2.port_a) annotation (points=[-40,70; -30,70;
  ...
  connect(ambient.port, orifice_p3.port_a) annotation (points=[-40,70; -30,70;
        -30,10; -20,10], style(color=69, rgbcolor={0,127,255}));
  connect(ambient.port, orifice_p4.port_a) annotation (points=[-40,70; -30,70;
  ...
  connect(ambient.port,orifice_p5. port_a) 
        ...
        -30,-50; -20,-50],
      style(color=69, rgbcolor={0,127,255}));
  connect(ambient.port, orifice_p6.port_a) annotation (points=[-40,70; -30,70;
  ...
  connect(orifice_p7.port_b, ambient_p7.port) 
    annotation (points=[0,-110; 20,-110],
                                      style(color=69, rgbcolor={0,127,255}));
  connect(orifice_p8.port_b, ambient_p8.port) annotation (points=[0,-140; 20,
        -140], style(color=69, rgbcolor={0,127,255}));
  connect(ambient.port, orifice_p7.port_a) annotation (points=[-40,70; -30,70;
        -30,-110; -20,-110], style(color=69, rgbcolor={0,127,255}));
  connect(ambient.port, orifice_p8.port_a) annotation (points=[-40,70; -30,70;
        -30,-140; -20,-140], style(color=69, rgbcolor={0,127,255}));
  connect(pump_m2.port, orifice_m2.port_a) annotation (points=[120,40; 140,40],
      style(color=69, rgbcolor={0,127,255}));
  connect(orifice_m2.port_b, ambient_m2.port) annotation (points=[160,40; 180,
        40], style(color=69, rgbcolor={0,127,255}));
  connect(pump_m3.port, orifice_m3.port_a) annotation (points=[120,10; 140,10],
      style(color=69, rgbcolor={0,127,255}));
  connect(orifice_m3.port_b, ambient_m3.port) annotation (points=[160,10; 180,
        10], style(color=69, rgbcolor={0,127,255}));
  connect(pump_m4.port, orifice_m4.port_a) annotation (points=[120,-20; 140,-20],
      style(color=69, rgbcolor={0,127,255}));
  connect(orifice_m4.port_b, ambient_m4.port) annotation (points=[160,-20; 180,
  ...
  connect(pump_m5.port, orifice_m5.port_a) annotation (points=[120,-50; 140,-50],
      style(color=69, rgbcolor={0,127,255}));
  connect(orifice_m5.port_b, ambient_m5.port) annotation (points=[160,-50; 180,
        -50], style(color=69, rgbcolor={0,127,255}));
  connect(pump_m6.port, orifice_m6.port_a) annotation (points=[120,-80; 140,-80],
      style(color=69, rgbcolor={0,127,255}));
  connect(orifice_m6.port_b, ambient_m6.port) annotation (points=[160,-80; 180,
  ...
  connect(orifice_m7.port_b, ambient_m7.port) annotation (points=[160,-110; 180,
        -110], style(color=69, rgbcolor={0,127,255}));
  connect(pump_m8.port, orifice_m8.port_a) annotation (points=[120,-140; 140,
        -140], style(color=69, rgbcolor={0,127,255}));
  connect(orifice_m8.port_b, ambient_m8.port) annotation (points=[160,-140; 180,
        -140], style(color=69, rgbcolor={0,127,255}));
