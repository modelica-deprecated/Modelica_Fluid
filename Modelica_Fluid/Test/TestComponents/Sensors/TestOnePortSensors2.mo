...
model TestOnePortSensors2
  ...
  Modelica_Fluid.Volumes.ClosedVolume MixingVolume1(
    V=1e-3,
    use_T_start=false,
  ...
  Modelica_Fluid.Sources.PrescribedMassFlowRate_hX FlowSource2(
    ...
    useFlowRateInput=true) 
            ...
            50}}, rotation=0)));
  Modelica_Fluid.Volumes.ClosedVolume MixingVolume2(
    V=1e-3,
    use_T_start=false,
    redeclare package Medium = Medium,
    h_start=1.5e5,
  ...
  Modelica.Blocks.Sources.Ramp ramp(
    ...
    duration=10) 
          ...
          rotation=0)));
  Modelica_Fluid.Volumes.ClosedVolume MixingVolume3(
    V=1e-3,
    use_T_start=false,
    redeclare package Medium = Medium,
    h_start=1e5,
  ...
  Modelica_Fluid.Sources.PrescribedMassFlowRate_hX FlowSource1(
    ...
    useFlowRateInput=true) 
                   annotation (Placement(transformation(extent={{-68,-30},{-48,
            -10}}, rotation=0)));
  Modelica_Fluid.Volumes.ClosedVolume MixingVolume4(
    V=1e-3,
    use_T_start=false,
    redeclare package Medium = Medium,
    h_start=1.5e5,
